...
use crate::shell::random::random_t;
...
use crate::shell::shell_common::builtin_read_params;
...
use crate::shell::math::arith_state_t;
  ...
  [
    ...
    },
    {
      let mut init = built_in_command {
        ...
        b_function: Some(
          crate::shell::shell_common::shell_builtin_ulimit
...
unsafe extern "C" fn add_strings_to_strings(
  ...
  count2 = 0 as libc::c_uint;
  v = add;
  while !(*v).is_null() {
    count2 = count2.wrapping_add(1);
    v = v.offset(1)
  }
  v = crate::libbb::xfuncs_printf::xrealloc(
  ...
  *fresh5 = std::ptr::null_mut::<libc::c_char>();
  ...
  loop {
    ...
    *fresh6 = if need_to_dup != 0 {
      crate::libbb::xfuncs_printf::xstrdup(*add.offset(i as isize))
    } else {
...
unsafe extern "C" fn add_string_to_strings(
  ...
  v[0] = add;
  v[1] = std::ptr::null_mut::<libc::c_char>();
  return add_strings_to_strings(strings, v.as_mut_ptr(), 0);
}
...
unsafe extern "C" fn move_HFILEs_on_redirect(
  ...
  if (*ptr_to_globals).x_mode_fd > 0 && fd == (*ptr_to_globals).x_mode_fd {
...
unsafe extern "C" fn save_and_replace_G_args(
  ...
  *fresh9 = *(*ptr_to_globals).global_argv.offset(0);
  ...
  (*ptr_to_globals).global_args_malloced = 0 as smalluint;
  (*ptr_to_globals).global_argc = (1i32 as libc::c_uint)
...
unsafe extern "C" fn hush_exit(mut exitcode: libc::c_int) -> ! {
  crate::libbb::xfuncs_printf::fflush_all();
  if (*ptr_to_globals).exiting as libc::c_int <= 0
    ...
    && *(*(*ptr_to_globals).traps.offset(0)).offset(0) as libc::c_int != 0
  {
    ...
    /* argv[0] is unused */
    argv[1] = crate::libbb::xfuncs_printf::xstrdup(*(*ptr_to_globals).traps.offset(0)); /* copy, since EXIT trap handler may modify G_traps[0] */
    argv[2] = std::ptr::null_mut::<libc::c_char>(); /* prevent EXIT trap recursion */
    (*ptr_to_globals).exiting = 1i32 as smallint;
...
unsafe extern "C" fn check_and_run_traps() -> libc::c_int {
  let mut last_sig: libc::c_int = 0; /* else: "" trap, ignoring signal */
  's_8: loop {
      ...
      && !(*(*ptr_to_globals).traps.offset(sig as isize)).is_null()
    {
      if *(*(*ptr_to_globals).traps.offset(sig as isize)).offset(0) != 0 {
        ...
        /* argv[0] is unused */
        argv[1] =
          crate::libbb::xfuncs_printf::xstrdup(*(*ptr_to_globals).traps.offset(sig as isize));
...
unsafe extern "C" fn get_cwd(mut force: libc::c_int) -> *const libc::c_char {
  if force != 0 || (*ptr_to_globals).cwd.is_null() {
    ...
    if (*ptr_to_globals).cwd == bb_msg_unknown.as_ptr() {
      (*ptr_to_globals).cwd = std::ptr::null()
    }
    (*ptr_to_globals).cwd =
      crate::libbb::xgetcwd::xrealloc_getcwd_or_warn((*ptr_to_globals).cwd as *mut libc::c_char);
...
unsafe extern "C" fn get_ptr_to_local_var(
  ...
  loop {
    ...
    if strncmp((*cur).varstr, name, len as libc::c_ulong) == 0
...
unsafe extern "C" fn get_local_var_value(mut name: *const libc::c_char) -> *const libc::c_char {
  ...
  if !(*ptr_to_globals).expanded_assignments.is_null() {
    ...
    while !(*cpp).is_null() {
      ...
      if strncmp(cp, name, len as libc::c_ulong) == 0
  ...
  if strcmp(name, b"PPID\x00" as *const u8 as *const libc::c_char) == 0 {
    return crate::libbb::xfuncs::utoa((*ptr_to_globals).root_ppid as libc::c_uint);
  }
  // bash compat: UID? EUID?
  if strcmp(name, b"RANDOM\x00" as *const u8 as *const libc::c_char) == 0 {
    return crate::libbb::xfuncs::utoa(crate::shell::random::next_random(
      &mut (*ptr_to_globals).random_gen,
    ));
  } /* including '=' */
  if strcmp(name, b"LINENO\x00" as *const u8 as *const libc::c_char) == 0 {
    return crate::libbb::xfuncs::utoa((*ptr_to_globals).execute_lineno);
  }
...
unsafe extern "C" fn handle_changed_special_names(
  ...
  if name_len == 6i32 as libc::c_uint {
    ...
    {
      (*ptr_to_globals).getopt_count = 0 as libc::c_uint;
      return;
    }
  };
}
unsafe extern "C" fn set_local_var(
  ...
  loop {
    ...
    if strncmp((*cur).varstr, str, name_len as libc::c_ulong) != 0 {
      cur_pp = &mut (*cur).next
    } else {
      ...
      if ((*cur).var_nest_level as libc::c_uint) < local_lvl {
        ...
        *cur_pp = (*cur).next;
        ...
        if !(strcmp((*cur).varstr.offset(name_len as isize), eq_sign.offset(1)) == 0) {
  ...
  match current_block {
    ...
    {
      cur = crate::libbb::xfuncs_printf::xzalloc(::std::mem::size_of::<variable>() as libc::c_ulong)
        as *mut variable;
...
unsafe extern "C" fn set_local_var_from_halves(
  ...
  set_local_var(var, 0 as libc::c_uint);
}
...
unsafe extern "C" fn unset_local_var_len(
  ...
  loop {
    ...
    if strncmp((*cur).varstr, name, name_len as libc::c_ulong) == 0
      && *(*cur).varstr.offset(name_len as isize) as libc::c_int == '=' as i32
    {
      ...
      *cur_pp = (*cur).next;
      crate::libbb::xfuncs_printf::bb_unsetenv((*cur).varstr);
      if (*cur).max_len == 0 {
  ...
  while !(*s).is_null() {
    ...
    match current_block_21 {
      10043043949733653460 => {
        set_local_var(
          *s,
          (*ptr_to_globals).var_nest_level << 3i32 | (1i32 << 0) as libc::c_uint,
        );
        s = s.offset(1)
      }
      _ => {}
...
unsafe extern "C" fn setup_prompt_string() -> *const libc::c_char {
  let mut prompt_str: *const libc::c_char = std::ptr::null();
  prompt_str = get_local_var_value(if (*ptr_to_globals).promptmode as libc::c_int == 0 {
...
unsafe extern "C" fn get_user_input(mut i: *mut in_str) -> libc::c_int {
  ...
  loop {
    ...
    if (*ptr_to_globals).flag_SIGINT != 0 {
      ...
      (*ptr_to_globals).flag_SIGINT = 0 as smallint
    }
    /* buglet: SIGINT will not make new prompt to appear _at once_,
     * only after <Enter>. (^C works immediately) */
    r = crate::libbb::lineedit::read_line_input(
    ...
    check_and_run_traps();
    if r != 0 && (*ptr_to_globals).flag_SIGINT == 0 {
      break;
    }
    /* ^C or SIGINT: repeat */
...
unsafe extern "C" fn o_reset_to_empty_unquoted(mut o: *mut o_string) {
  (*o).length = 0;
  (*o).has_quoted_part = 0 as smallint;
  if !(*o).data.is_null() {
...
unsafe extern "C" fn o_grow_by(mut o: *mut o_string, mut len: libc::c_int) {
  if (*o).length + len > (*o).maxlen {
    ...
    (*o).data = crate::libbb::xfuncs_printf::xrealloc(
...
unsafe extern "C" fn x_mode_flush() {
  ...
  (*ptr_to_globals).x_mode_buf.length = 0;
}
/*
...
unsafe extern "C" fn o_save_ptr_helper(mut o: *mut o_string, mut n: libc::c_int) -> libc::c_int {
  ...
  if (*o).has_empty_slot == 0 {
    ...
    if n & 0xfi32 == 0 {
      ...
      *fresh14 = std::ptr::null_mut::<libc::c_char>();
    ...
    string_len = (*o).length - string_start;
    (*o).has_empty_slot = 0 as smallint
  }
  (*o).has_quoted_part = 0 as smallint;
...
unsafe extern "C" fn next_brace_sub(mut cp: *const libc::c_char) -> *const libc::c_char {
  let mut depth: libc::c_uint = 0 as libc::c_uint;
  cp = cp.offset(1);
  while *cp as libc::c_int != '\u{0}' as i32 {
    if *cp as libc::c_int == '\\' as i32 {
      ...
      if *cp as libc::c_int == '}' as i32 && {
        ...
        (fresh16) == 0 as libc::c_uint
      } || *cp as libc::c_int == ',' as i32 && depth == 0 as libc::c_uint
      {
        break;
      }
      let fresh17 = cp;
...
unsafe extern "C" fn glob_brace(
  ...
  let mut current_block: u64;
  let mut new_pattern_buf: *mut libc::c_char = std::ptr::null_mut::<libc::c_char>();
  let mut begin: *const libc::c_char = std::ptr::null();
  let mut next: *const libc::c_char = std::ptr::null();
  let mut rest: *const libc::c_char = std::ptr::null();
  ...
  gr = glob(pattern, 0, None, &mut globdata);
  if gr != 0 {
    if gr == 3i32 {
...
unsafe extern "C" fn new_pipe() -> *mut pipe {
  ...
  pi = crate::libbb::xfuncs_printf::xzalloc(::std::mem::size_of::<pipe>() as libc::c_ulong)
    as *mut pipe;
...
unsafe extern "C" fn done_command(mut ctx: *mut parse_context) -> libc::c_int {
  ...
  match current_block {
    2979737022853876585 => {
      ...
      (*pi).cmds = crate::libbb::xfuncs_printf::xrealloc(
...
unsafe extern "C" fn done_pipe(mut ctx: *mut parse_context, mut type_0: pipe_style) {
  ...
  (*ctx).ctx_inverted = 0 as smallint;
    ...
    && (*ctx).list_head != (*ctx).pipe
  {
    ...
    match current_block_20 {
      ...
      _ => {
        ...
        (*pi).num_cmds = 1i32;
        (*pi).cmds =
          crate::libbb::xfuncs_printf::xzalloc(::std::mem::size_of::<command>() as libc::c_ulong)
            as *mut command;
        command = &mut *(*pi).cmds.offset(0) as *mut command;
        if 0 != 0 {
          /* "if xzalloc didn't do that already" */
          (*command).cmd_type = 0 as smallint
        }
...
unsafe extern "C" fn initialize_context(mut ctx: *mut parse_context) {
  ...
  if MAYBE_ASSIGNMENT as libc::c_int != 0 {
...
unsafe extern "C" fn match_reserved_word(mut word: *mut o_string) -> *const reserved_combo {
  ...
  {
    if strcmp((*word).data, (*r).literal.as_ptr()) == 0 {
      return r;
    }
    r = r.offset(1)
  }
...
unsafe extern "C" fn reserved_word(mut ctx: *mut parse_context) -> *const reserved_combo {
  ...
  if (*r).flag & FLAG_START as libc::c_int != 0 {
    ...
    old = crate::libbb::xfuncs_printf::xmemdup(
  ...
  if (*ctx).old_flag & FLAG_END as libc::c_int != 0 {
    ...
    (*(*old_0).command).cmd_type = 0 as smallint;
    *ctx = *old_0;
...
unsafe extern "C" fn done_word(mut ctx: *mut parse_context) -> libc::c_int {
  let mut command: *mut command = (*ctx).command;
  if (*ctx).word.length == 0 && (*ctx).word.has_quoted_part == 0 {
    return 0;
  }
  if !(*ctx).pending_redirect.is_null() {
    ...
    (*(*ctx).pending_redirect).rd_filename = crate::libbb::xfuncs_printf::xstrdup((*ctx).word.data);
    /* Cater for >\file case:
      ...
      ) != 0
    {
      ...
      (*ctx).ctx_dsemicolon = 0 as smallint
    } else if (*command).argv.is_null()
      && (*ctx).ctx_res_w as libc::c_int != RES_FOR as libc::c_int
      && (*ctx).ctx_res_w as libc::c_int != RES_IN as libc::c_int
      && (*ctx).ctx_res_w as libc::c_int != RES_CASE as libc::c_int
    {
      let mut reserved: *const reserved_combo = std::ptr::null();
    ...
    (*command).argv = add_string_to_strings(
      (*command).argv,
      crate::libbb::xfuncs_printf::xstrdup((*ctx).word.data),
    )
  }
  if (*ctx).ctx_res_w as libc::c_int == RES_FOR as libc::c_int {
    if (*ctx).word.has_quoted_part as libc::c_int != 0
      || *crate::libbb::endofname::endofname(*(*command).argv.offset(0)).offset(0) as libc::c_int
        != '\u{0}' as i32
    {
...
unsafe extern "C" fn parse_redir_right_fd(mut input: *mut in_str) -> libc::c_int {
  ...
  crate::libbb::verror_msg::bb_simple_error_msg(
    b"ambiguous redirect\x00" as *const u8 as *const libc::c_char,
  );
...
unsafe extern "C" fn parse_redirect(
  ...
  redir =
    crate::libbb::xfuncs_printf::xzalloc(::std::mem::size_of::<redir_struct>() as libc::c_ulong)
      as *mut redir_struct;
  *redirp = redir;
  /* redir->next = NULL; */
...
unsafe extern "C" fn redirect_opt_num(mut o: *mut o_string) -> libc::c_int {
  ...
  num = crate::libbb::bb_strtonum::bb_strtou((*o).data, 0 as *mut *mut libc::c_char, 10i32)
    as libc::c_int;
  if *bb_errno != 0 || num < 0 {
    return -1i32;
  }
...
unsafe extern "C" fn fetch_till_str(
   ...
   * EOF
   */
  heredoc.data = crate::libbb::xfuncs_printf::xzalloc(1i32 as size_t) as *mut libc::c_char; /* start as "", not as NULL */
  loop {
      ...
      match current_block {
        ...
        _ => {
          if heredoc_flags & HEREDOC_QUOTED as libc::c_int != 0 || prev != '\\' as i32 {
            ...
            if strcmp(heredoc.data.offset(past_EOL as isize), word) == 0 {
...
unsafe extern "C" fn parse_group(
  ...
  if (*command).cmd_type as libc::c_int == 3i32 && endch == ')' as i32 {
    ...
    cmd2 = crate::libbb::xfuncs_printf::xzalloc(::std::mem::size_of::<command>() as libc::c_ulong)
      as *mut command;
...
unsafe extern "C" fn add_till_closing_bracket(
  ...
  //bb_error_msg("%s:o_addchr('%c') after '\\'", __func__, ch);
  {
    ...
    if ch == '(' as i32 || ch == '{' as i32 {
      ...
      if add_till_backquote(dest, input, 0) == 0 {
        return 0;
      }
      o_addchr(dest, ch);
    } else {
                  ...
                  && bb_ascii_isalnum(ch as libc::c_uchar) == 0
              {
                ...
                's_205: loop {
                  ...
                  if bb_ascii_isalnum(ch as libc::c_uchar) == 0 && ch != '_' as i32 {
                    ...
                    len_single_ch = 0 as libc::c_char
                  }
                }
                match current_block_96 {
                  3145260671063309080 => {}
...
unsafe extern "C" fn parse_stream(
   ...
   * Preventing this:
   */
  ctx.word.data = crate::libbb::xfuncs_printf::xzalloc(1i32 as size_t) as *mut libc::c_char; /* start as "", not as NULL */
   ...
   */
  heredoc_cnt = 0; /* while (1) */
  's_38: loop
  /* not ""(... */
  {
    let mut is_blank: *const libc::c_char = std::ptr::null();
    let mut is_special: *const libc::c_char = std::ptr::null();
    let mut ch: libc::c_int = 0;
    let mut next: libc::c_int = 0;
    ...
    if ch == -1i32 {
      ...
      if heredoc_cnt != 0 {
        ...
        if (*pi).num_cmds == 0 && (*pi).res_word as libc::c_int == RES_NONE as libc::c_int {
          free_pipe_list(pi);
          pi = std::ptr::null_mut()
        }
      ...
      if ch == '\'' as i32 {
        ...
        if is_special.is_null() && is_blank.is_null() {
           ...
           */
          if ch == '}' as i32 {
            if ctx.word.length != 0 || ctx.word.has_quoted_part as libc::c_int != 0 {
              current_block = 18309173857163198886;
        ...
        match current_block {
          ...
          /* ""} */
          {
            ...
            if (ctx.is_assignment as libc::c_int == MAYBE_ASSIGNMENT as libc::c_int
              || ctx.is_assignment as libc::c_int == WORD_IS_KEYWORD as libc::c_int)
              && ch == '=' as i32
              && *crate::libbb::endofname::endofname(ctx.word.data).offset(0) as libc::c_int
                == '=' as i32
            {
...
unsafe extern "C" fn expand_on_ifs(
  ...
  let mut last_is_ifs: libc::c_int = 0;
  loop {
...
unsafe extern "C" fn encode_then_expand_string(mut str: *const libc::c_char) -> *mut libc::c_char {
  let mut exp_str: *mut libc::c_char = std::ptr::null_mut::<libc::c_char>(); /* string has no special chars */
...
unsafe extern "C" fn encode_then_expand_vararg(
  ...
  setup_string_in_str(&mut input, str);
  dest.data = crate::libbb::xfuncs_printf::xzalloc(1i32 as size_t) as *mut libc::c_char;
  exp_str = std::ptr::null_mut::<libc::c_char>();
  /* error */
  loop
  //debug_printf_subst("SUBST RES3 '%s'\n", dest->data + pos);
  {
...
unsafe extern "C" fn strstr_pattern(
  ...
  loop {
    let mut end: *mut libc::c_char = crate::shell::r#match::scan_and_match(
      val,
      pattern,
...
unsafe extern "C" fn replace_pattern(
  ...
  let mut res_len: libc::c_uint = 0 as libc::c_uint;
...
unsafe extern "C" fn expand_one_var(
  ...
  let mut val: *const libc::c_char = std::ptr::null(); /* points to expansion operator */
  let mut to_be_freed: *mut libc::c_char = std::ptr::null_mut::<libc::c_char>(); /* for compiler */
  let mut p: *mut libc::c_char = std::ptr::null_mut::<libc::c_char>(); /* replace trailing SPECIAL_VAR_SYMBOL */
  let mut var: *mut libc::c_char = std::ptr::null_mut::<libc::c_char>();
  let mut exp_op: libc::c_char = 0;
  let mut exp_save: libc::c_char = 0;
  exp_save = exp_save;
  let mut exp_saveptr: *mut libc::c_char = std::ptr::null_mut::<libc::c_char>();
  let mut exp_word: *mut libc::c_char = std::ptr::null_mut::<libc::c_char>();
  exp_word = exp_word;
  let mut arg0: libc::c_char = 0;
  val = std::ptr::null();
  to_be_freed = std::ptr::null_mut::<libc::c_char>();
  p = *pp;
  ...
  *arg.offset(0) = (arg0 as libc::c_int & 0x7fi32) as libc::c_char;
  ...
  if (*var.offset(0) as libc::c_int - '0' as i32) as libc::c_uchar as libc::c_int <= 9i32 {
    ...
    let mut nn: libc::c_int = crate::libbb::xatonum::xatoi_positive(var);
    ...
    match *var.offset(0) as libc::c_int {
      36 => {
        /* pid */
        val = crate::libbb::xfuncs::utoa((*ptr_to_globals).root_pid as libc::c_uint)
      }
      33 => {
        /* bg pid */
        val = if (*ptr_to_globals).last_bg_pid != 0 {
          crate::libbb::xfuncs::utoa((*ptr_to_globals).last_bg_pid as libc::c_uint)
        } else {
          b"\x00" as *const u8 as *const libc::c_char
        }
      }
      63 => {
        /* exitcode */
        val = crate::libbb::xfuncs::utoa((*ptr_to_globals).last_exitcode as libc::c_uint)
      }
      35 => {
        /* argc */
        val = crate::libbb::xfuncs::utoa(if (*ptr_to_globals).global_argc != 0 {
  ...
  if exp_op as libc::c_int == 'L' as i32 {
    ...
    val = crate::libbb::xfuncs::utoa(if !val.is_null() {
      crate::libbb::unicode::unicode_strlen(val)
    } else {
      0 as libc::c_ulong
    } as libc::c_uint)
  } else if exp_op != 0 {
    if exp_op as libc::c_int == '%' as i32 || exp_op as libc::c_int == '#' as i32 {
      ...
      if !val.is_null() && *val.offset(0) as libc::c_int != 0 {
        ...
        let mut exp_exp_word: *mut libc::c_char = std::ptr::null_mut::<libc::c_char>();
        ...
        exp_exp_word = encode_then_expand_vararg(exp_word, 1i32, 0);
        ...
        loc = crate::shell::r#match::scan_and_match(t, exp_word, scan_flags);
      ...
      if !val.is_null() && *val.offset(0) as libc::c_int != 0 {
         ...
         */
        let mut pattern: *mut libc::c_char = std::ptr::null_mut::<libc::c_char>();
        let mut repl: *mut libc::c_char = std::ptr::null_mut::<libc::c_char>();
        let mut t_0: *mut libc::c_char = std::ptr::null_mut::<libc::c_char>();
        pattern = encode_then_expand_vararg(exp_word, 1i32, 0);
        if pattern.is_null() {
          pattern = crate::libbb::xfuncs_printf::xstrdup(exp_word)
        }
        let fresh28 = p;
        p = p.offset(1);
        ...
        *p = '\u{0}' as i32 as libc::c_char;
        ...
        if !errmsg.is_null() {
            ...
            || beg as libc::c_ulonglong >= strlen(val) as libc::c_ulonglong
          {
            ...
            to_be_freed =
              crate::libbb::xfuncs_printf::xstrndup(val.offset(beg as isize), len as libc::c_int);
            val = to_be_freed;
        ...
        if exp_op as libc::c_int == '+' as i32 || exp_op as libc::c_int == '-' as i32 {
          ...
          if exp_op as libc::c_int == '=' as i32 {
              ...
              || *var.offset(0) as libc::c_int == '#' as i32
            {
              ...
              let mut new_var: *mut libc::c_char = crate::libbb::xfuncs_printf::xasprintf(
                b"%s=%s\x00" as *const u8 as *const libc::c_char,
                var,
                val,
              );
              set_local_var(new_var, 0 as libc::c_uint);
            }
          }
        }
      }
...
unsafe extern "C" fn expand_vars_to_list(
   ...
   */
  let mut cant_be_null: libc::c_char = 0 as libc::c_char; /* only bit 0x80 matters */
  let mut p: *mut libc::c_char = std::ptr::null_mut::<libc::c_char>(); /* end of "while (SPECIAL_VAR_SYMBOL is found) ..." */
  loop {
    p = strchr(arg, 3i32);
    if p.is_null() {
      break;
    ...
    if (*output).ended_in_ifs != 0 {
      o_addchr(output, '\u{0}' as i32);
      n = o_save_ptr(output, n);
      (*output).ended_in_ifs = 0 as smallint
    }
    o_addblock(
      output,
      arg,
...
unsafe extern "C" fn expand_string_to_string(
  ...
  if strchr(str, 3i32).is_null() && strchr(str, '\\' as i32).is_null() {
    ...
    return crate::libbb::xfuncs_printf::xstrdup(str);
  }
  ...
  if (*list.offset(0)).is_null() {
    ...
    *(list as *mut libc::c_char).offset(0) = '\u{0}' as i32 as libc::c_char
    ...
    if !(*list.offset(1)).is_null() {
      crate::libbb::verror_msg::bb_simple_error_msg_and_die(
        b"BUG in varexp2\x00" as *const u8 as *const libc::c_char,
      );
    }
    /* actually, just move string 2*sizeof(char*) bytes back */
    crate::libbb::safe_strncpy::overlapping_strcpy(list as *mut libc::c_char, *list.offset(0));
    if do_unbackslash != 0 {
...
unsafe extern "C" fn switch_off_special_sigs(mut mask: libc::c_uint) {
  let mut sig: libc::c_uint = 0 as libc::c_uint;
  loop
  /* trap is '', has to remain SIG_IGN */
  {
    mask >>= 1i32;
    if !(mask != 0 as libc::c_uint) {
      break;
    }
    ...
    if !(*ptr_to_globals).traps.is_null() {
      ...
      *fresh33 = std::ptr::null_mut::<libc::c_char>()
    }
...
unsafe extern "C" fn reset_traps_to_defaults() {
  ...
  (*ptr_to_globals).fatal_sig_mask = 0 as libc::c_uint;
  ...
  sig = 0 as libc::c_uint; /* no trap: nothing to do */
  while sig < (64i32 + 1i32) as libc::c_uint {
    if !(*(*ptr_to_globals).traps.offset(sig as isize)).is_null() {
      if !(*(*(*ptr_to_globals).traps.offset(sig as isize)).offset(0) == 0) {
        ...
        *fresh34 = std::ptr::null_mut::<libc::c_char>();
        /* There is no signal for trap 0 (EXIT) */
        if !(sig == 0 as libc::c_uint) {
...
unsafe extern "C" fn parse_and_run_stream(mut inp: *mut in_str, mut end_trigger: libc::c_int) {
  ...
  loop {
    ...
    if end_trigger == ';' as i32 {
      (*ptr_to_globals).promptmode = 0 as smallint
    }
    ...
    if pipe_list.is_null() || pipe_list == 1 as *mut libc::c_void as *mut pipe {
      ...
      if pipe_list == 1 as *mut libc::c_void as *mut pipe && end_trigger == ';' as i32 {
        ...
        if pipe_list.is_null() && empty as libc::c_int != 0 {
          (*ptr_to_globals).last_exitcode = 0 as smalluint
        }
        break;
      }
    } else {
...
unsafe extern "C" fn generate_stream_from_string(
  ...
  crate::libbb::xfuncs_printf::xpipe(channel.as_mut_ptr());
  pid = if 1i32 != 0 {
  ...
  if pid == 0 {
    ...
    (*ptr_to_globals).random_gen.galois_LFSR = 0;
...
unsafe extern "C" fn process_command_subs(
  ...
  fp = crate::libbb::wfopen::xfdopen_for_read(generate_stream_from_string(s, &mut pid));
...
unsafe extern "C" fn setup_heredoc(mut redir: *mut redir_struct) {
  ...
  expanded = std::ptr::null_mut::<libc::c_char>();
  ...
  close((*redir).rd_fd);
  crate::libbb::xfuncs_printf::xpipe(&mut pair.rd);
  crate::libbb::xfuncs_printf::xmove_fd(pair.rd, (*redir).rd_fd);
  ...
  crate::libbb::xfuncs::ndelay_off(pair.wr);
  ...
  if pid == 0 {
    ...
    crate::libbb::full_write::full_write(pair.wr, heredoc as *const libc::c_void, len as size_t); /* may loop or block */
    _exit(0i32);
  }
  /* parent */
  die_func = ::std::mem::transmute::<
...
unsafe extern "C" fn append_squirrel(
  ...
  sq = crate::libbb::xfuncs_printf::xrealloc(
...
unsafe extern "C" fn add_squirrel(
  ...
  i = 0;
  if !sq.is_null() {
    while (*sq.offset(i as isize)).orig_fd >= 0 {
      ...
      if fd == (*sq.offset(i as isize)).moved_to {
        ...
        if (*sq.offset(i as isize)).moved_to < 0 {
          /* what? */
          crate::libbb::xfunc_die::xfunc_die();
        }
        return sq;
...
unsafe extern "C" fn setup_redirects(
  ...
  while !redir.is_null() {
    ...
    if (*redir).rd_type as libc::c_int == REDIRECT_HEREDOC2 as libc::c_int {
      /* "rd_fd<<HERE" case */
      save_fd_on_redirect((*redir).rd_fd, 0, sqp);
      ...
      if (*redir).rd_dup == REDIRFD_TO_FILE as libc::c_int {
        ...
        if (*redir).rd_filename.is_null() {
          ...
          newfd = crate::libbb::xfuncs_printf::open_or_warn(p, mode);
        ...
        _ => {
          if !(newfd == (*redir).rd_fd) {
             ...
             */
              ...
              crate::libbb::xfuncs_printf::xdup2(newfd, (*redir).rd_fd);
              if (*redir).rd_dup == REDIRFD_TO_FILE as libc::c_int {
                /* else: "rd_fd > rd_dup" */
                /* "rd_fd > FILE" */
...
unsafe extern "C" fn find_in_path(mut arg: *const libc::c_char) -> *mut libc::c_char {
  ...
  loop {
    ...
    if sz != 0 {
      ...
      ret = crate::libbb::xfuncs_printf::xstrdup(arg)
    }
    if access(ret, 0) == 0 {
      break;
    }
...
unsafe extern "C" fn leave_var_nest_level() {
  ...
  if 1i32 != 0 && ((*ptr_to_globals).var_nest_level as libc::c_int) < 0 {
    crate::libbb::verror_msg::bb_simple_error_msg_and_die(
      b"BUG: nesting underflow\x00" as *const u8 as *const libc::c_char,
    );
  }
  remove_nested_vars();
}
...
unsafe extern "C" fn new_function(mut name: *mut libc::c_char) -> *mut function {
  ...
  if !funcp.is_null() {
    ...
    *funcpp =
      crate::libbb::xfuncs_printf::xzalloc(::std::mem::size_of::<function>() as libc::c_ulong)
        as *mut function;
    funcp = *funcpp
    /*funcp->next = NULL;*/
  }
...
unsafe extern "C" fn exec_function(
  ...
  *fresh36 = *(*ptr_to_globals).global_argv.offset(0);
  (*ptr_to_globals).global_argv = argv;
  n = (1i32 as libc::c_uint).wrapping_add(crate::libbb::appletlib::string_array_len(argv.offset(1)))
    as libc::c_int;
...
unsafe extern "C" fn execvp_or_die(mut argv: *mut *mut libc::c_char) -> ! {
  ...
  if SPECIAL_JOBSTOP_SIGS as libc::c_int != 0 {
...
unsafe extern "C" fn if_command_vV_print_and_exit(
  ...
  let mut to_free: *mut libc::c_char = std::ptr::null_mut::<libc::c_char>();
  if opt_vV == 0 {
    return;
  }
  to_free = std::ptr::null_mut::<libc::c_char>();
  if explanation.is_null() {
    ...
    to_free = crate::libbb::executable::find_executable(cmd, &mut path); /* path == NULL is ok */
...
unsafe extern "C" fn pseudo_exec_argv(
  ...
  let mut opt_vV: libc::c_char = 0 as libc::c_char;
  let mut funcp: *const function = std::ptr::null();
  ...
  if strchr(*argv.offset(0), '/' as i32).is_null() {
    ...
    {
      let mut p: *mut libc::c_char = std::ptr::null_mut::<libc::c_char>(); /* bash allows "command command command [-OPT] BAR" */
...
unsafe extern "C" fn get_cmdtext(mut pi: *mut pipe) -> *const libc::c_char {
  ...
  if argv.is_null() {
    (*pi).cmdtext = crate::libbb::xfuncs_printf::xzalloc(1i32 as size_t) as *mut libc::c_char;
    return (*pi).cmdtext;
  }
  len = 0;
  loop {
...
unsafe extern "C" fn remove_job_from_table(mut pi: *mut pipe) {
  ...
  (*ptr_to_globals).last_jobid = 0 as libc::c_uint;
...
unsafe extern "C" fn insert_job_into_table(mut pi: *mut pipe) {
  ...
  *jobp = crate::libbb::xfuncs_printf::xmemdup(
  ...
  (*job).cmdtext = crate::libbb::xfuncs_printf::xstrdup(get_cmdtext(pi));
  if (*ptr_to_globals).interactive_fd != 0 {
    printf(
      b"[%u] %u %s\n\x00" as *const u8 as *const libc::c_char,
      (*job).jobid,
...
unsafe extern "C" fn job_exited_or_stopped(mut pi: *mut pipe) -> libc::c_int {
  ...
  loop {
    ...
    if (*ptr_to_globals).o_opt[OPT_O_PIPEFAIL as libc::c_int as usize] as libc::c_int == 0
      || rcode != 0
    {
      break;
    }
...
unsafe extern "C" fn process_wait_result(
  ...
  dead = (status & 0x7fi32 == 0
    || ((status & 0x7fi32) + 1i32) as libc::c_schar as libc::c_int >> 1i32 > 0)
    as libc::c_int;
  ...
  if !fg_pipe.is_null() {
    ...
    loop {
      ...
      if dead != 0 {
        ...
        (*(*fg_pipe).cmds.offset(i as isize)).pid = 0;
        ...
        if ((status & 0x7fi32) + 1i32) as libc::c_schar as libc::c_int >> 1i32 > 0 {
          ...
          if i == (*fg_pipe).num_cmds - 1i32 {
            ...
            puts(if sig == 2i32 || sig == 13i32 {
              ...
              crate::libbb::u_signal_names::get_signame(sig)
            });
          }
  ...
  match current_block {
    ...
    _ => {
      if dead != 0 {
        ...
        (*(*pi).cmds.offset(i as isize)).pid = 0;
        (*pi).alive_cmds -= 1;
        if (*pi).alive_cmds == 0 {
   ...
   */
  {
    ...
    if childpid <= 0 {
      ...
      /* "wait PID" called us, give it exitcode+1 */
        ...
        if !(-1i32 == waitfor_pid && (*ptr_to_globals).dead_job_exitcode >= 0) {
          continue;
        }
        /* some job did finish */
...
unsafe extern "C" fn checkjobs_and_fg_shell(mut fg_pipe: *mut pipe) -> libc::c_int {
  let mut p: pid_t = 0;
  let mut rcode: libc::c_int = checkjobs(fg_pipe, 0);
...
unsafe extern "C" fn run_pipe(mut pi: *mut pipe) -> libc::c_int {
  ...
  let mut current_block: u64;
  static mut null_ptr: *const libc::c_char = std::ptr::null();
    ...
    || (*command).cmd_type as libc::c_int == 1i32)
  {
    ...
    if !(*command).group.is_null() {
      ...
      if setup_redirects(command, &mut squirrel) == 0 {
    ...
    let mut x: *const built_in_command = std::ptr::null();
    let mut funcp_0: *const function = std::ptr::null();
    let mut sv_shadowed: *mut *mut variable = std::ptr::null_mut();
    ...
    if (*argv.offset((*command).assignment_cnt as isize)).is_null() {
       ...
       */
      i = 0;
      (*ptr_to_globals).expand_exitcode = 0 as smalluint;
    ...
    match current_block {
      ...
      _ => {
        ...
        while i < (*command).assignment_cnt {
          ...
          if set_local_var(p_0, 0 as libc::c_uint) != 0 {
  ...
  while cmd_no < (*pi).num_cmds {
    ...
    if cmd_no < (*pi).num_cmds {
      crate::libbb::xfuncs_printf::xpipe(&mut pipefds.rd);
    }
    (*ptr_to_globals).execute_lineno = (*command).lineno;
    ...
    if (*command).pid == 0 {
      ...
      (*ptr_to_globals).random_gen.galois_LFSR = 0; /* or else $RANDOM repeats in child */
      ...
      if (*pi).alive_cmds == 0 && (*pi).followup as libc::c_int == PIPE_BG as libc::c_int {
        /* 1st cmd in backgrounded pipe
         * should have its stdin /dev/null'ed */
        close(0i32);
        if open(b"/dev/null\x00" as *const u8 as *const libc::c_char, 0) != 0 {
          crate::libbb::xfuncs_printf::xopen(b"/\x00" as *const u8 as *const libc::c_char, 0);
        }
      } else {
        crate::libbb::xfuncs_printf::xmove_fd(next_infd, 0);
      }
      crate::libbb::xfuncs_printf::xmove_fd(pipefds.wr, 1i32);
      if pipefds.rd > 1i32 {
        close(pipefds.rd);
      }
    ...
    if (*command).pid < 0 {
      ...
      crate::libbb::perror_msg::bb_simple_perror_msg(if 1i32 != 0 {
...
unsafe extern "C" fn run_list(mut pi: *mut pipe) -> libc::c_int {
  ...
  let mut cond_code: smalluint = 0 as smalluint;
  ...
  while !pi.is_null() {
    ...
    if rword as libc::c_int == last_rword as libc::c_int && 1i32 != 0 {
      if rcode as libc::c_int == 0 && last_followup as libc::c_int == PIPE_OR as libc::c_int
        || rcode as libc::c_int != 0 && last_followup as libc::c_int == PIPE_AND as libc::c_int
      {
              ...
              match current_block {
                ...
                _ => {
                  ...
                  if (*pi).num_cmds == 0 {
                    ...
                    (*ptr_to_globals).flag_break_continue = 0 as smallint; /* NB: rcode is a smalluint, r is int */
                    r = run_pipe(pi);
                    ...
                    if r != -1i32 {
                      ...
                      if (*ptr_to_globals).flag_break_continue != 0 {
                        ...
                        if !loop_top.is_null() {
                          ...
                          if (*ptr_to_globals).depth_break_continue == 0 as libc::c_uint {
                            (*ptr_to_globals).flag_break_continue = 0 as smallint
                      ...
                      if (*pi).followup as libc::c_int == PIPE_BG as libc::c_int {
                        ...
                        (*ptr_to_globals).last_bg_pid_exitcode = 0 as smalluint;
                        ...
                        && (*ptr_to_globals).interactive_fd != 0
                      {
                        ...
                        rcode = checkjobs(pi, 0) as smalluint
                      }
                      (*ptr_to_globals).last_exitcode = rcode;
                      check_and_run_traps();
                      current_block = 13479157322803929894;
                      ...
                      _ => {
                        ...
                        if rcode as libc::c_int != 0
                          && (*ptr_to_globals).o_opt[OPT_O_ERREXIT as libc::c_int as usize]
                            ...
                            != 0
                        {
                          if (*ptr_to_globals).errexit_depth == 0 {
...
unsafe extern "C" fn install_sighandlers(mut mask: libc::c_uint) {
  ...
  loop {
      ...
      == ::std::mem::transmute::<libc::intptr_t, __sighandler_t>(1i32 as libc::intptr_t)
    {
      ...
      if (*ptr_to_globals).traps.is_null() {
        (*ptr_to_globals).traps = crate::libbb::xfuncs_printf::xzalloc(
      ...
      *fresh41 = crate::libbb::xfuncs_printf::xzalloc(1i32 as size_t) as *mut libc::c_char
      /* == xstrdup(""); */
    }
  }
}
  ...
  match mode as libc::c_int {
    ...
    111 => {
      if o_opt.is_null() {
        ...
        idx = crate::libbb::compare_string_array::index_in_strings(o_opt_strings.as_ptr(), o_opt);
        if idx >= 0 {
...
pub unsafe extern "C" fn hush_main(
  ...
  *fresh42 = crate::libbb::xfuncs_printf::xzalloc(::std::mem::size_of::<globals>() as libc::c_ulong)
  ...
  shell_ver =
    crate::libbb::xfuncs_printf::xzalloc(::std::mem::size_of::<variable>() as libc::c_ulong)
      as *mut variable;
  ...
  (*shell_ver).varstr = crate::libbb::xfuncs_printf::xstrdup(hush_version_str.as_ptr());
  ...
  /* Export PWD */
  set_pwd_var((1i32 << 0) as libc::c_uint);
  ...
  /* G_interactive_fd++; */
  {
    ...
    match opt {
      99 => {
        ...
        if builtin_argc != 0 {
          ...
          if !x.is_null() {
            ...
            *fresh43 = std::ptr::null_mut::<libc::c_char>();
            crate::libbb::xfuncs_printf::fflush_all();
      ...
      110 | 120 | 101 => {
        if set_mode(1i32, opt as libc::c_char, 0 as *const libc::c_char) == 0 {
          /* no error */
          continue;
        }
      }
    ...
    10007731352114176167 => {
      ...
      *fresh45 = *argv.offset(0);
      ...
      if (*ptr_to_globals).opt_s == 0 && !(*(*ptr_to_globals).global_argv.offset(1)).is_null() {
        ...
        if input_0.is_null() {
          crate::libbb::perror_msg::bb_simple_perror_msg_and_die(
            *(*ptr_to_globals).global_argv.offset(0),
          );
        }
        ...
        if (*ptr_to_globals).interactive_fd != 0 {
          crate::libbb::xfuncs::close_on_exec_on((*ptr_to_globals).interactive_fd);
          if (*ptr_to_globals).saved_tty_pgrp != 0 {
            loop
          ...
          (*ptr_to_globals).line_input_state =
            crate::libbb::lineedit::new_line_input_t(FOR_SHELL as libc::c_int);
          ...
          if hp.is_null() {
            ...
            if !hp.is_null() {
              hp = crate::libbb::concat_path_file::concat_path_file(
                hp,
                b".hush_history\x00" as *const u8 as *const libc::c_char,
              )
            }
          } else {
            hp = crate::libbb::xfuncs_printf::xstrdup(hp)
          }
          if !hp.is_null() {
          ...
          (*(*ptr_to_globals).line_input_state).max_history =
            crate::libbb::lineedit::size_from_HISTFILESIZE(hp) as libc::c_int
        } else {
          install_special_sighandlers();
        }
        /* bash:
...
unsafe extern "C" fn builtin_history(mut _argv: *mut *mut libc::c_char) -> libc::c_int {
  if !(*ptr_to_globals).line_input_state.is_null() {
    crate::libbb::lineedit::show_history((*ptr_to_globals).line_input_state);
  }
  return 0;
}
...
unsafe extern "C" fn builtin_cd(mut argv: *mut *mut libc::c_char) -> libc::c_int {
  let mut newdir: *const libc::c_char = std::ptr::null();
  ...
  if chdir(newdir) != 0 {
    ...
    crate::libbb::perror_msg::bb_perror_msg(
      b"cd: %s\x00" as *const u8 as *const libc::c_char,
      newdir,
    );
    return 1i32;
  }
...
unsafe extern "C" fn builtin_exit(mut argv: *mut *mut libc::c_char) -> libc::c_int {
  ...
  hush_exit(crate::libbb::xatonum::xatoi(*argv.offset(0)) & 0xffi32);
}
...
unsafe extern "C" fn builtin_read(mut argv: *mut *mut libc::c_char) -> libc::c_int {
   ...
   */
  params.read_flags = crate::libbb::getopt32::getopt32(
    argv,
  ...
  if r as uintptr_t > 1i32 as libc::c_ulong {
    crate::libbb::verror_msg::bb_simple_error_msg(r);
...
unsafe extern "C" fn builtin_umask(mut argv: *mut *mut libc::c_char) -> libc::c_int {
  ...
  if !(*argv.offset(0)).is_null() {
    ...
    mask = crate::libbb::parse_mode::bb_parse_mode(*argv.offset(0), mask) as mode_t;
    if !((*(*argv.offset(0)).offset(0) as libc::c_int - '0' as i32) as libc::c_uchar as libc::c_int
      <= 9i32)
    {
      mask ^= 0o777i32 as libc::c_uint
...
unsafe extern "C" fn helper_export_local(
  ...
  loop {
    ...
    let mut name_end: *const libc::c_char = crate::libbb::endofname::endofname(name);
    if *name_end as libc::c_int == '\u{0}' as i32 {
      ...
      if flags & (1i32 << 1i32) as libc::c_uint != 0 {
        ...
        if !var.is_null() {
          (*var).flg_export = 0 as smallint; /* else: export -n NOT_EXISTING_VAR: no-op */
          unsetenv(name);
        }
        ...
        match current_block_24 {
          ...
          _ => {
            ...
            match current_block_24 {
              ...
              /* Is this "local" bltin? */
              {
                if flags & (1i32 << 0 | 1i32 << 1i32 | 1i32 << 2i32) as libc::c_uint == 0 {
                ...
                match current_block_24 {
                  ...
                  _ => {
                     ...
                     * in the future.
                     */
                    name = crate::libbb::xfuncs_printf::xasprintf(
                      b"%s=\x00" as *const u8 as *const libc::c_char,
                      name,
                    );
      ...
      name = crate::libbb::xfuncs_printf::xstrdup(name);
...
unsafe extern "C" fn builtin_export(mut argv: *mut *mut libc::c_char) -> libc::c_int {
  ...
  /* "!": do not abort on errors */
  opt_unexport =
    crate::libbb::getopt32::getopt32(argv, b"!n\x00" as *const u8 as *const libc::c_char);
...
unsafe extern "C" fn builtin_local(mut argv: *mut *mut libc::c_char) -> libc::c_int {
  if (*ptr_to_globals).func_nest_level == 0 as libc::c_uint {
    crate::libbb::verror_msg::bb_error_msg(
...
unsafe extern "C" fn builtin_unset(mut argv: *mut *mut libc::c_char) -> libc::c_int {
  ...
  opts = crate::libbb::getopt32::getopt32(argv, b"!+vf\x00" as *const u8 as *const libc::c_char);
  if opts == -1i32 as libc::c_uint {
    return 1i32;
  }
  if opts == 3i32 as libc::c_uint {
    crate::libbb::verror_msg::bb_simple_error_msg(
      b"unset: -v and -f are exclusive\x00" as *const u8 as *const libc::c_char,
    );
    return 1i32;
  }
  argv = argv.offset(optind as isize);
...
unsafe extern "C" fn builtin_set(mut argv: *mut *mut libc::c_char) -> libc::c_int {
  ...
  loop {
    if strcmp(arg, b"--\x00" as *const u8 as *const libc::c_char) == 0 {
      argv = argv.offset(1);
  ...
  if (*ptr_to_globals).global_args_malloced != 0 {
    ...
    *fresh48 = std::ptr::null_mut::<libc::c_char>()
  } else {
    (*ptr_to_globals).global_args_malloced = 1i32 as smalluint;
    pp = crate::libbb::xfuncs_printf::xzalloc(
      (::std::mem::size_of::<*mut libc::c_char>() as libc::c_ulong)
  ...
  (*ptr_to_globals).global_argc = (1i32 as libc::c_uint)
    .wrapping_add(crate::libbb::appletlib::string_array_len(pp.offset(1)))
    as libc::c_int;
  return 0;
}
unsafe extern "C" fn builtin_shift(mut argv: *mut *mut libc::c_char) -> libc::c_int {
  ...
  argv = skip_dash_dash(argv);
  if !(*argv.offset(0)).is_null() {
    n = crate::libbb::bb_strtonum::bb_strtou(*argv.offset(0), 0 as *mut *mut libc::c_char, 10i32)
      as libc::c_int;
    if *bb_errno != 0 || n < 0 {
  ...
  if n >= 0 && n < (*ptr_to_globals).global_argc {
    if (*ptr_to_globals).global_args_malloced != 0 {
...
unsafe extern "C" fn builtin_getopts(mut argv: *mut *mut libc::c_char) -> libc::c_int {
  ...
  */
  ...
  n = crate::libbb::appletlib::string_array_len(argv) as libc::c_int;
  loop {
  ...
  set_local_var_from_halves(
    b"OPTIND\x00" as *const u8 as *const libc::c_char,
    crate::libbb::xfuncs::utoa(optind as libc::c_uint),
...
unsafe extern "C" fn builtin_source(mut argv: *mut *mut libc::c_char) -> libc::c_int {
  ...
  arg_path = std::ptr::null_mut::<libc::c_char>();
...
unsafe extern "C" fn builtin_trap(mut argv: *mut *mut libc::c_char) -> libc::c_int {
  ...
  let mut current_block: u64;
  let mut sig: libc::c_int = 0;
  let mut new_cmd: *mut libc::c_char = std::ptr::null_mut::<libc::c_char>();
  if (*ptr_to_globals).traps.is_null() {
    (*ptr_to_globals).traps = crate::libbb::xfuncs_printf::xzalloc(
      (::std::mem::size_of::<*mut libc::c_char>() as libc::c_ulong)
        .wrapping_mul((64i32 + 1i32) as libc::c_ulong),
  ...
  if (*argv).is_null() {
    ...
    while i < 64i32 + 1i32 {
      if !(*(*ptr_to_globals).traps.offset(i as isize)).is_null() {
        ...
        printf(
          b" %s\n\x00" as *const u8 as *const libc::c_char,
          crate::libbb::u_signal_names::get_signame(i),
        );
      }
      i += 1
    }
  ...
  new_cmd = std::ptr::null_mut::<libc::c_char>();
  /* If first arg is a number: reset all specified signals */
  sig =
    crate::libbb::bb_strtonum::bb_strtou(*argv, 0 as *mut *mut libc::c_char, 10i32) as libc::c_int;
  if *bb_errno == 0 {
    ret = 0;
  } else {
    if (*argv.offset(1)).is_null() {
      /* no second arg */
      crate::libbb::verror_msg::bb_simple_error_msg(
        b"trap: invalid arguments\x00" as *const u8 as *const libc::c_char,
      );
      return 1i32;
    }
  ...
  while !(*argv).is_null() {
    ...
    let fresh53 = argv;
    argv = argv.offset(1);
    sig = crate::libbb::u_signal_names::get_signum(*fresh53);
    if sig < 0 {
      ret = 1i32;
      /* Mimic bash message exactly */
      crate::libbb::verror_msg::bb_error_msg(
      ...
      *fresh54 = crate::libbb::xfuncs_printf::xstrdup(new_cmd);
...
unsafe extern "C" fn builtin_jobs(mut _argv: *mut *mut libc::c_char) -> libc::c_int {
  let mut job: *mut pipe = std::ptr::null_mut();
  let mut status_string: *const libc::c_char = std::ptr::null();
  checkjobs(0 as *mut pipe, 0);
  job = (*ptr_to_globals).job_list;
  while !job.is_null() {
...
unsafe extern "C" fn builtin_fg_bg(mut argv: *mut *mut libc::c_char) -> libc::c_int {
  ...
  i = 0; /* FG job shouldn't be in job table */
  while i < (*pi).num_cmds {
    i += 1
  }
  (*pi).stopped_cmds = 0;
  ...
  if i < 0 {
    ...
    crate::libbb::perror_msg::bb_simple_perror_msg(
      b"kill (SIGCONT)\x00" as *const u8 as *const libc::c_char,
    );
  }
  if *(*argv.offset(0)).offset(0) as libc::c_int == 'f' as i32 {
    remove_job_from_table(pi);
...
unsafe extern "C" fn wait_for_child_or_signal(
  ...
  loop {
    ...
    if !(sigisemptyset(&mut (*ptr_to_globals).pending_set) == 0) {
      ...
      crate::libbb::signals::sigprocmask2(2i32, &mut oldset);
      if !(sigisemptyset(&mut (*ptr_to_globals).pending_set) == 0) {
...
unsafe extern "C" fn builtin_wait(mut argv: *mut *mut libc::c_char) -> libc::c_int {
  ...
  if (*argv.offset(0)).is_null() {
     ...
     * $
     */
    return wait_for_child_or_signal(0 as *mut pipe, 0);
  } /* bash compat for bad jobspecs */
  loop {
    let mut pid: pid_t =
      crate::libbb::bb_strtonum::bb_strtou(*argv, 0 as *mut *mut libc::c_char, 10i32) as pid_t;
    if *bb_errno != 0 || pid <= 0 {
      if *(*argv.offset(0)).offset(0) as libc::c_int == '%' as i32 {
    ...
    /* bash checks all argv[] */
      ...
      if ret < 0 {
        ...
        if *bb_errno == 10i32 {
          ...
          /* ??? */
          crate::libbb::perror_msg::bb_perror_msg(
            b"wait %s\x00" as *const u8 as *const libc::c_char,
            *argv,
          );
        }
      } else if ret == 0 {
...
unsafe extern "C" fn parse_numeric_argv1(
  ...
  if !(*argv.offset(1)).is_null() {
    def = crate::libbb::bb_strtonum::bb_strtou(*argv.offset(1), 0 as *mut *mut libc::c_char, 10i32);
...
unsafe extern "C" fn builtin_break(mut argv: *mut *mut libc::c_char) -> libc::c_int {
  ...
  if (*ptr_to_globals).depth_of_loop == 0 as libc::c_uint {
    crate::libbb::verror_msg::bb_error_msg(
...
unsafe extern "C" fn builtin_times(mut _argv: *mut *mut libc::c_char) -> libc::c_int {
  ...
  clk_tck = crate::libbb::sysconf::bb_clk_tck();
  times(&mut buf);
  p = times_tbl.as_ptr();
  loop {
