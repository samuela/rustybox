...
static mut dc_LEX_to_INST: [i8; 42] = [
  XC_INST_POWER as libc::c_int as i8,
  XC_INST_MULTIPLY as libc::c_int as i8,
  XC_INST_DIVIDE as libc::c_int as i8,
  XC_INST_MODULUS as libc::c_int as i8,
  XC_INST_PLUS as libc::c_int as i8,
  XC_INST_MINUS as libc::c_int as i8,
  XC_INST_BOOL_NOT as libc::c_int as i8,
  DC_INST_INVALID as libc::c_int as i8,
  XC_INST_REL_GT as libc::c_int as i8,
  DC_INST_INVALID as libc::c_int as i8,
  DC_INST_INVALID as libc::c_int as i8,
  XC_INST_IBASE as libc::c_int as i8,
  XC_INST_SCALE as libc::c_int as i8,
  XC_INST_OBASE as libc::c_int as i8,
  XC_INST_LENGTH as libc::c_int as i8,
  XC_INST_PRINT as libc::c_int as i8,
  DC_INST_QUIT as libc::c_int as i8,
  XC_INST_SQRT as libc::c_int as i8,
  XC_INST_REL_GE as libc::c_int as i8,
  XC_INST_REL_EQ as libc::c_int as i8,
  DC_INST_MODEXP as libc::c_int as i8,
  DC_INST_DIVMOD as libc::c_int as i8,
  DC_INST_INVALID as libc::c_int as i8,
  DC_INST_INVALID as libc::c_int as i8,
  DC_INST_EXECUTE as libc::c_int as i8,
  DC_INST_PRINT_STACK as libc::c_int as i8,
  DC_INST_CLEAR_STACK as libc::c_int as i8,
  DC_INST_STACK_LEN as libc::c_int as i8,
  DC_INST_DUPLICATE as libc::c_int as i8,
  DC_INST_SWAP as libc::c_int as i8,
  XC_INST_POP as libc::c_int as i8,
  DC_INST_ASCIIFY as libc::c_int as i8,
  DC_INST_PRINT_STREAM as libc::c_int as i8,
  DC_INST_INVALID as libc::c_int as i8,
  DC_INST_INVALID as libc::c_int as i8,
  DC_INST_INVALID as libc::c_int as i8,
  DC_INST_INVALID as libc::c_int as i8,
  ...
  DC_INST_INVALID as libc::c_int as i8,
  XC_INST_PRINT as libc::c_int as i8,
  DC_INST_NQUIT as libc::c_int as i8,
  XC_INST_SCALE_FUNC as libc::c_int as i8,
];
...
unsafe fn bc_num_subArrays(mut a: *mut BcDig, mut b: *mut BcDig, mut len: size_t) {
  ...
  while i < len {
    ...
    *fresh2 = (*fresh2 as libc::c_int - *b.offset(i as isize) as libc::c_int) as BcDig;
    j = i;
    while (*a.offset(j as isize) as libc::c_int) < 0 {
      let fresh3 = j;
      j = j.wrapping_add(1);
...
unsafe fn bc_num_cmp(mut a: *mut BcNum, mut b: *mut BcNum) -> ssize_t {
  ...
  let mut max_num: *mut BcDig = std::ptr::null_mut();
  let mut min_num: *mut BcDig = std::ptr::null_mut();
...
unsafe fn zbc_num_binary(
  ...
  let mut num2: BcNum = std::mem::zeroed();
  let mut ptr_a: *mut BcNum = std::ptr::null_mut();
  let mut ptr_b: *mut BcNum = std::ptr::null_mut();
  let mut init: bool = 0 != 0;
  if c == a {
    ptr_a = &mut num2;
    memcpy(
...
unsafe fn zbc_num_a(
  ...
  let mut ptr: *mut BcDig = std::ptr::null_mut();
  let mut ptr_a: *mut BcDig = std::ptr::null_mut();
  let mut ptr_b: *mut BcDig = std::ptr::null_mut();
  let mut ptr_c: *mut BcDig = std::ptr::null_mut();
  let mut i: size_t = 0;
...
unsafe fn zbc_num_s(
  ...
  let mut cmp: ssize_t = 0;
  let mut minuend: *mut BcNum = std::ptr::null_mut();
  let mut subtrahend: *mut BcNum = std::ptr::null_mut();
...
unsafe fn zbc_num_k(mut a: *mut BcNum, mut b: *mut BcNum, mut c: *mut BcNum) -> BcStatus {
  ...
  let mut l1: BcNum = std::mem::zeroed();
  let mut h1: BcNum = std::mem::zeroed();
  let mut l2: BcNum = std::mem::zeroed();
  let mut h2: BcNum = std::mem::zeroed();
  let mut m2: BcNum = std::mem::zeroed();
  let mut m1: BcNum = std::mem::zeroed();
  let mut z0: BcNum = std::mem::zeroed();
  let mut z1: BcNum = std::mem::zeroed();
  let mut z2: BcNum = std::mem::zeroed();
  let mut temp: BcNum = std::mem::zeroed();
  let mut aone: bool = false;
  if (*a).len == 0 as libc::c_ulong || (*b).len == 0 as libc::c_ulong {
    bc_num_zero(c);
    return BC_STATUS_SUCCESS;
  }
  aone = (*a).len == 1i32 as libc::c_ulong
    && (*a).rdx == 0 as libc::c_ulong
    && *(*a).num.offset(0) as libc::c_int == 1i32;
  if aone as libc::c_int != 0
    || (*b).len == 1i32 as libc::c_ulong
      && (*b).rdx == 0 as libc::c_ulong
    ...
    || (*b).len < 32i32 as libc::c_ulong
  {
    ...
    i = 0 as size_t;
    while i < (*b).len {
      let mut carry: libc::c_uint = 0 as libc::c_uint;
      j = 0 as size_t;
      while j < (*a).len {
  ...
  s = zbc_num_add(&mut h1, &mut l1, &mut m1, 0 as size_t);
  if !(s as u64 != 0) {
    s = zbc_num_add(&mut h2, &mut l2, &mut m2, 0 as size_t);
    if !(s as u64 != 0) {
      ...
      if !(s as u64 != 0) {
        ...
        if !(s as u64 != 0) {
          ...
          if !(s as u64 != 0) {
            s = zbc_num_sub(&mut z1, &mut z0, &mut temp, 0 as size_t);
            if !(s as u64 != 0) {
              s = zbc_num_sub(&mut temp, &mut z2, &mut z1, 0 as size_t);
              if !(s as u64 != 0) {
                s = zbc_num_shift(&mut z0, max2.wrapping_mul(2i32 as libc::c_ulong));
                if !(s as u64 != 0) {
                  s = zbc_num_shift(&mut z1, max2);
                  if !(s as u64 != 0) {
                    s = zbc_num_add(&mut z0, &mut z1, &mut temp, 0 as size_t);
                    if !(s as u64 != 0) {
                      s = zbc_num_add(&mut temp, &mut z2, c, 0 as size_t)
                    }
                  }
                }
              }
...
unsafe fn zbc_num_m(
  ...
  let mut s: BcStatus = BC_STATUS_SUCCESS;
  let mut cpa: BcNum = std::mem::zeroed();
  let mut cpb: BcNum = std::mem::zeroed();
...
unsafe fn zbc_num_d(
  ...
  let mut i: size_t = 0;
  let mut cp: BcNum = std::mem::zeroed();
  if (*b).len == 0 as libc::c_ulong {
  ...
  if (*b).rdx == (*b).len {
    while !(len == 0 as libc::c_ulong) {
      ...
      if *(*b).num.offset(len as isize) as libc::c_int != 0 {
        break;
      }
    }
  ...
  *cp.num.offset(fresh8 as isize) = 0 as BcDig;
  ...
  while i < end {
    let mut n: *mut BcDig = std::ptr::null_mut();
    let mut q: BcDig = 0;
    n = cp.num.offset(i as isize);
    q = 0 as BcDig;
    while *n.offset(len as isize) as libc::c_int != 0 || bc_num_compare(n, (*b).num, len) >= 0 {
...
unsafe fn zbc_num_rem(
  ...
  let mut s: BcStatus = BC_STATUS_SUCCESS;
  let mut c1: BcNum = std::mem::zeroed();
...
unsafe fn zbc_num_p(
  ...
  let mut s: BcStatus = BC_STATUS_SUCCESS;
  let mut copy: BcNum = std::mem::zeroed();
  ...
  i = 0 as size_t;
  while i < (*b).rdx {
    if *(*b).num.offset(i as isize) as libc::c_int != 0 {
          ...
          match current_block {
            ...
            _ => {
              ...
              loop {
                ...
                if *(*c).num.offset(i as isize) as libc::c_int != 0 {
                  current_block = 177946457580043942;
                  break;
                }
                i = i.wrapping_add(1)
...
unsafe fn zbc_num_sqrt(mut a: *mut BcNum, mut b: *mut BcNum, mut scale: size_t) -> BcStatus {
  ...
  let mut num2: BcNum = std::mem::zeroed();
  let mut half: BcNum = std::mem::zeroed();
  let mut f: BcNum = std::mem::zeroed();
  let mut fprime: BcNum = std::mem::zeroed();
  let mut x0: *mut BcNum = std::ptr::null_mut();
  let mut x1: *mut BcNum = std::ptr::null_mut();
  let mut temp: *mut BcNum = std::ptr::null_mut();
...
unsafe fn zdc_num_modexp(
  ...
  let mut s: BcStatus = BC_STATUS_SUCCESS;
  let mut base: BcNum = std::mem::zeroed();
  let mut exp: BcNum = std::mem::zeroed();
  let mut two: BcNum = std::mem::zeroed();
  let mut temp: BcNum = std::mem::zeroed();
  let mut two_digs: [BcDig; 1] = [0; 1];
  if (*c).len == 0 as libc::c_ulong {
    return bc_error(b"divide by zero\x00" as *const u8 as *const libc::c_char) as BcStatus;
  }
  ...
  bc_num_one(d);
  s = zbc_num_rem(a, c, &mut base, 0 as size_t);
  if !(s as u64 != 0) {
    bc_num_copy(&mut exp, b);
    while exp.len != 0 as libc::c_ulong {
      s = zbc_num_divmod(&mut exp, &mut two, &mut exp, &mut temp, 0 as size_t);
      if s as u64 != 0 {
        break;
      }
      if temp.len == 1i32 as libc::c_ulong
        && temp.rdx == 0 as libc::c_ulong
        && *temp.num.offset(0) as libc::c_int == 1i32
      {
        s = zbc_num_mul(d, &mut base, &mut temp, 0 as size_t);
        if s as u64 != 0 {
          break;
        }
        s = zbc_num_rem(&mut temp, c, d, 0 as size_t);
        if s as u64 != 0 {
          break;
        }
      }
      s = zbc_num_mul(&mut base, &mut base, &mut temp, 0 as size_t);
      if s as u64 != 0 {
        break;
      }
      s = zbc_num_rem(&mut temp, c, &mut base, 0 as size_t);
      if s as u64 != 0 {
        break;
      }
    }
...
unsafe fn bc_array_expand(mut a: *mut BcVec, mut len: size_t) {
  if (*a).dtor == Some(bc_num_free) {
    ...
    let mut v: BcVec = std::mem::zeroed();
    while len > (*a).len {
...
unsafe fn bc_num_parseBase(
  ...
  let mut current_block: u64;
  let mut s: BcStatus = BC_STATUS_SUCCESS;
  let mut mult: BcNum = std::mem::zeroed();
  let mut result: BcNum = std::mem::zeroed();
  let mut temp: BcNum = std::mem::zeroed();
  let mut base: BcNum = std::mem::zeroed();
  ...
  loop {
    ...
    s = zbc_num_mul(n, &mut base, &mut mult, 0 as size_t);
    if s as u64 != 0 {
      current_block = 6365745064265978751;
      break;
    }
    bc_num_ulong2num(&mut temp, v as libc::c_ulong);
    s = zbc_num_add(&mut mult, &mut temp, n, 0 as size_t);
    if s as u64 != 0 {
      current_block = 6365745064265978751;
      break;
    }
  ...
  match current_block {
    11298138898191919651 => {
      ...
      loop {
        ...
        s = zbc_num_mul(&mut result, &mut base, &mut result, 0 as size_t);
        if s as u64 != 0 {
          current_block = 2795181157028703675;
          break;
        }
        bc_num_ulong2num(&mut temp, v_0 as libc::c_ulong);
        s = zbc_num_add(&mut result, &mut temp, &mut result, 0 as size_t);
        if s as u64 != 0 {
          current_block = 2795181157028703675;
          break;
        }
        s = zbc_num_mul(&mut mult, &mut base, &mut mult, 0 as size_t);
        if s as u64 != 0 {
          current_block = 2795181157028703675;
          break;
        }
...
unsafe fn peek_inbuf() -> libc::c_char {
    ...
    && !(*ptr_to_globals).prs.lex_input_fp.is_null()
  {
    ...
    if (*ptr_to_globals).input_buffer.len <= 1i32 as libc::c_ulong {
      ...
      (*ptr_to_globals).prs.lex_input_fp = std::ptr::null_mut()
    }
  }
...
unsafe fn zbc_lex_identifier() -> BcStatus {
      ...
      .wrapping_div(::std::mem::size_of::<BcLexKeyword>() as libc::c_ulong) as libc::c_uint
  {
    ...
    let mut j: libc::c_uint = 0 as libc::c_uint;
    loop {
...
unsafe fn xc_program_add_fn() {
  ...
  let mut f: BcFunc = BcFunc {
    code: std::mem::zeroed(),
    labels: std::mem::zeroed(),
    autos: std::mem::zeroed(),
    strs: std::mem::zeroed(),
    consts: std::mem::zeroed(),
    nparams: 0,
    voidfunc: false,
  };
  bc_func_init(&mut f);
...
unsafe fn bc_program_addFunc(mut name: *mut libc::c_char) -> size_t {
  ...
  let mut entry_ptr: *mut BcId = std::ptr::null_mut();
...
unsafe fn zbc_parse_params(mut flags: u8) -> BcStatus {
  ...
  flags = (flags as libc::c_int & !(1i32 << 1i32 | 1i32 << 0) | 1i32 << 2i32) as u8;
  s = zxc_lex_next();
  if s as u64 != 0 {
    return s;
  }
      ...
      if s as u64 != 0 {
        ...
        if (*p).lex as libc::c_int == BC_LEX_RBRACKET as libc::c_int {
          ...
          *type_0 = XC_INST_ARRAY_ELEM;
          flags = (flags as libc::c_int & !(1i32 << 1i32 | 1i32 << 0)) as u8;
          s = zbc_parse_expr(flags);
          if s as u64 != 0 {
            current_block = 11734377364214890191;
          } else {
...
unsafe fn zbc_parse_break_or_continue(mut type_0: BcLexType) -> BcStatus {
  ...
  if type_0 as libc::c_uint == BC_LEX_KEY_BREAK as libc::c_int as libc::c_uint {
    if (*p).exits.len == 0 as libc::c_ulong {
...
unsafe fn zbc_func_insert(
  ...
  let mut autoid: *mut BcId = std::ptr::null_mut();
  let mut a: BcId = BcId {
    name: std::ptr::null_mut::<libc::c_char>(),
    idx: 0,
  };
...
unsafe fn zbc_parse_expr(mut flags: u8) -> BcStatus {
  ...
  let mut nexprs: size_t = 0 as size_t;
  ...
  if flags as libc::c_int & 1i32 << 0 == 0 && nrelops != 0 {
  ...
  } else if flags as libc::c_int & 1i32 << 0 != 0 && nrelops > 1i32 as libc::c_uint {
...
unsafe fn zdc_parse_token(mut t: BcLexType) -> BcStatus {
  ...
  match t as libc::c_uint {
    ...
    50 | 51 => {
      ...
      s = zdc_parse_mem(inst, 1i32 != 0, 0 != 0)
    }
    47 | 49 | 48 => {
      ...
      s = zdc_parse_mem(inst, 0 != 0, 1i32 != 0)
    }
    _ => return bc_error_bad_token() as BcStatus,
  }
...
unsafe fn xc_program_search(mut id: *mut libc::c_char, mut type_0: BcType) -> *mut BcVec {
  ...
  let mut ptr: *mut BcId = std::ptr::null_mut();
  let mut v: *mut BcVec = std::ptr::null_mut();
  let mut map: *mut BcVec = std::ptr::null_mut();
  let mut i: size_t = 0;
  ...
  if new != 0 {
    let mut v2: BcVec = std::mem::zeroed();
...
unsafe fn zxc_program_binOpPrep(
  ...
  *r = bc_vec_item_rev(&mut (*ptr_to_globals).prog.results, 0 as size_t) as *mut BcResult;
...
unsafe fn zxc_program_op(mut inst: libc::c_char) -> BcStatus {
  ...
  let mut n1: *mut BcNum = std::ptr::null_mut();
  let mut n2: *mut BcNum = std::ptr::null_mut();
  s = zxc_program_binOpPrep(&mut opd1, &mut n1, &mut opd2, &mut n2, 0 != 0);
  if s as u64 != 0 {
    return s;
  }
...
unsafe fn zxc_num_printNum(
  ...
  let mut base: BcNum = std::mem::zeroed();
  let mut base_digs: [BcDig; 20] = [0; 20];
  let mut intp: BcNum = std::mem::zeroed();
  let mut fracp: BcNum = std::mem::zeroed();
  let mut digit: BcNum = std::mem::zeroed();
  let mut frac_len: BcNum = std::mem::zeroed();
  let mut dig: libc::c_ulong = 0;
  let mut ptr: *mut libc::c_ulong = std::ptr::null_mut();
  let mut i: size_t = 0;
  let mut radix: bool = false;
  if (*n).len == 0 as libc::c_ulong {
    print.expect("non-null function pointer")(0i32 as size_t, width, 0 != 0);
    return BC_STATUS_SUCCESS;
  }
  bc_vec_init(
    &mut stack,
  ...
  s = zbc_num_sub(n, &mut intp, &mut fracp, 0 as size_t);
  if s as u64 != 0 {
  ...
  loop {
    match current_block {
      ...
      _ => {
        if intp.len != 0 as libc::c_ulong {
          s = zbc_num_divmod(&mut intp, &mut base, &mut intp, &mut digit, 0 as size_t);
          if s as u64 != 0 {
            current_block = 15705001814182199965;
            continue;
          }
          ...
          while i < stack.len {
            ...
            print.expect("non-null function pointer")(*ptr, width, 0 != 0);
            i = i.wrapping_add(1)
          }
          if (*n).rdx == 0 {
            current_block = 15705001814182199965;
          ...
          loop {
            ...
            s = zbc_num_sub(&mut fracp, &mut intp, &mut fracp, 0 as size_t);
            if s as u64 != 0 {
              current_block = 15705001814182199965;
              break;
            }
            print.expect("non-null function pointer")(dig, width, radix);
            s = zbc_num_mul(&mut frac_len, &mut base, &mut frac_len, 0 as size_t);
            if s as u64 != 0 {
              current_block = 15705001814182199965;
              break;
            }
...
unsafe fn zdc_program_assignStr(
  ...
  let mut n2: BcNum = std::mem::zeroed();
  let mut res: BcResult = BcResult {
    t: XC_RESULT_TEMP,
    d: BcResultData {
      n: std::mem::zeroed(),
...
unsafe fn zxc_program_popResultAndCopyToVar(
  ...
  let mut vec: *mut BcVec = std::ptr::null_mut();
...
unsafe fn zxc_program_assign(mut inst: libc::c_char) -> BcStatus {
  ...
  let mut l: *mut BcNum = std::ptr::null_mut();
  let mut r: *mut BcNum = std::ptr::null_mut();
  ...
  if (*right).t as libc::c_uint == XC_RESULT_STR as libc::c_int as libc::c_uint {
    ...
    return zdc_program_assignStr(right, v, 0 != 0);
  }
...
unsafe fn zbc_program_pushArray(
  ...
  if inst as libc::c_int == XC_INST_ARRAY as libc::c_int {
    ...
    let mut operand: *mut BcResult = std::ptr::null_mut();
...
unsafe fn zbc_program_call(mut code: *mut libc::c_char, mut idx: *mut size_t) -> BcStatus {
  ...
  let mut i: size_t = 0;
  let mut nparams: size_t = 0;
  let mut a: *mut BcId = std::ptr::null_mut();
  let mut func: *mut BcFunc = std::ptr::null_mut();
  nparams = xc_program_index(code, idx);
  ip.func = xc_program_index(code, idx);
  func = xc_program_func(ip.func);
  if (*func).code.len == 0 as libc::c_ulong {
  ...
  i = 0 as size_t;
  while i < nparams {
    let mut arg: *mut BcResult = std::ptr::null_mut();
    let mut s: BcStatus = BC_STATUS_SUCCESS;
...
unsafe fn xc_program_len(mut n: *mut BcNum) -> libc::c_ulong {
  ...
  while !(len == 0 as libc::c_ulong) {
    len = len.wrapping_sub(1);
    if *(*n).num.offset(len as isize) as libc::c_int != 0 {
      break;
    }
  }
  return len;
...
unsafe fn zxc_program_builtin(mut inst: libc::c_char) -> BcStatus {
    ...
    && (*opnd).t as libc::c_uint == XC_RESULT_ARRAY as libc::c_int as libc::c_uint
  {
    ...
    && !((*opnd).t as libc::c_uint != XC_RESULT_ARRAY as libc::c_int as libc::c_uint
      ...
      && !((*num).num.is_null() && (*num).cap == 0))
  {
    let mut str: *mut *mut libc::c_char = std::ptr::null_mut();
    let mut idx: size_t =
...
unsafe fn zdc_program_modexp() -> BcStatus {
  ...
  let mut r3: *mut BcResult = std::ptr::null_mut();
  let mut res: BcResult = BcResult {
    t: XC_RESULT_TEMP,
    d: BcResultData {
      n: std::mem::zeroed(),
  ...
  let mut n1: *mut BcNum = std::ptr::null_mut();
  let mut n2: *mut BcNum = std::ptr::null_mut();
  let mut n3: *mut BcNum = std::ptr::null_mut();
  if !((*ptr_to_globals).prog.results.len > 2i32 as size_t) {
    return bc_error_stack_has_too_few_elements() as BcStatus;
  }
  s = zxc_program_binOpPrep(&mut r2, &mut n2, &mut r3, &mut n3, 0 != 0);
  if s as u64 != 0 {
    return s;
  }
...
unsafe fn zdc_program_asciify() -> BcStatus {
  ...
  let mut num: *mut BcNum = std::ptr::null_mut();
  let mut n: BcNum = std::mem::zeroed();
  let mut strs: *mut *mut libc::c_char = std::ptr::null_mut();
  let mut str: *mut libc::c_char = std::ptr::null_mut::<libc::c_char>();
  let mut c: libc::c_char = 0;
  let mut idx: size_t = 0;
  if !((*ptr_to_globals).prog.results.len > 0 as size_t) {
  ...
  {
    let mut val: libc::c_ulong = 0;
    let mut strmb: BcNum = std::mem::zeroed();
    ...
    s = zbc_num_mod(&mut n, &mut strmb, &mut n, 0 as size_t);
    if s as u64 != 0 {
...
unsafe fn zdc_program_execStr(
  ...
  if cond {
    ...
    let mut else_name: *mut libc::c_char = std::ptr::null_mut::<libc::c_char>();
    if *code.offset(*bgn as isize) as libc::c_int == '\u{0}' as i32 {
      *bgn = (*bgn as libc::c_ulong).wrapping_add(1i32 as libc::c_ulong) as size_t as size_t
    } else {
      else_name = xc_program_name(code, bgn)
    }
    exec = (*r).d.n.len != 0 as libc::c_ulong;
    name = then_name;
    ...
    let mut n_0: *mut BcNum = std::ptr::null_mut();
  ...
  match current_block {
    11048769245176032998 => {
      ...
      if (*f).code.len == 0 as libc::c_ulong {
        let mut sv_parse: BcParse = std::mem::zeroed();
        let mut str: *mut libc::c_char = std::ptr::null_mut::<libc::c_char>();
        sv_parse = (*ptr_to_globals).prs;
...
unsafe fn zxc_program_exec() -> BcStatus {
  ...
  while (*ip).inst_idx < (*func).code.len {
    ...
    match inst as libc::c_int {
      ...
      28 => {
        s = xc_program_pushVar(code, &mut (*ip).inst_idx, 0 != 0, 0 != 0);
        current_block = 4299703460566765016;
      }
      29 | 30 => {
      ...
      39 | 40 | 42 => {
        s = xc_program_print(inst, 0 as size_t);
        current_block = 4299703460566765016;
      }
      41 => {
        r.t = XC_RESULT_STR;
      ...
      17 => {
        let mut num_0: *mut BcNum = std::ptr::null_mut();
      ...
      61 => {
        let mut ptr2: *mut BcResult = std::ptr::null_mut();
        if !((*ptr_to_globals).prog.results.len > 1i32 as size_t) {
          return bc_error_stack_has_too_few_elements() as BcStatus;
        }
        ptr = bc_vec_item_rev(&mut (*ptr_to_globals).prog.results, 0 as size_t) as *mut BcResult;
        ptr2 =
      ...
      10048703153582371463 => {
        if !(s as libc::c_uint != 0 || bb_got_signal as libc::c_int != 0) {
          ...
          if s as u64 != 0 {
            ...
            // storage.
            if 1i32 != 0 && (1i32 == 0 || *applet_name.offset(0) as libc::c_int == 'b' as i32) {
              if (*ptr_to_globals).prog.results.len != 0 as libc::c_ulong {
                // should be empty
                crate::libbb::verror_msg::bb_simple_error_msg_and_die(
              ...
              if (*ptr_to_globals).prog.results.len == 0 as libc::c_ulong
                && (*ptr_to_globals).prog.vars.len == 0 as libc::c_ulong
              {
