...
unsafe extern "C" fn print_route(
  ...
  if (*(bb_common_bufsiz1.as_mut_ptr() as *mut filter_t))
    ...
    .family as libc::c_int
    != 0
    && crate::networking::libiproute::utils::inet_addr_match(
      &mut dst,
  ...
  if !tb[RTA_OIF as libc::c_int as usize].is_null() {
    printf(
      ...
      crate::networking::libiproute::ll_map::ll_index_to_name(
        *((tb[RTA_OIF as libc::c_int as usize] as *mut libc::c_char).offset(
          ((::std::mem::size_of::<rtattr>() as libc::c_ulong)
            .wrapping_add(4u32 as libc::c_ulong)
            .wrapping_sub(1i32 as libc::c_ulong)
    ...
    && (*(bb_common_bufsiz1.as_mut_ptr() as *mut filter_t)).tb == 0
  {
    printf(
      ...
      crate::networking::libiproute::rt_names::rtnl_rttable_n2a(tid as libc::c_int),
    );
  }
  ...
  if (*r).rtm_flags & 0x200i32 as libc::c_uint == 0 {
      ...
      && (*(bb_common_bufsiz1.as_mut_ptr() as *mut filter_t)).scopemask != -1i32
    {
      printf(
        ...
        crate::networking::libiproute::rt_names::rtnl_rtscope_n2a((*r).rtm_scope as libc::c_int),
      );
    }
  }
    ...
    if (*r).rtm_flags & 0x200i32 as libc::c_uint != 0 || !ci.is_null() && (*ci).rta_expires != 0 {
      ...
      if (*ci).rta_expires != 0 {
        printf(
          ...
          ((*ci).rta_expires as libc::c_uint)
            .wrapping_div(crate::networking::libiproute::utils::get_hz()),
        );
      }
...
unsafe extern "C" fn iproute_modify(
  ...
  while !(*argv).is_null() {
    ...
    if arg == ARG_src as libc::c_int {
      ...
      crate::networking::libiproute::utils::get_addr(
        &mut addr,
        *argv,
      ...
      mtu = crate::networking::libiproute::utils::get_unsigned(
        *argv,
        keywords
          .as_ptr()
      ...
      crate::networking::libiproute::libnetlink::rta_addattr32(
        mxrta,
      ...
      mss = crate::networking::libiproute::utils::get_unsigned(
        *argv,
        keywords
          .as_ptr()
          .offset(::std::mem::size_of::<[libc::c_char; 4]>() as libc::c_ulong as isize)
      ...
      let mut scope: u32 = 0;
      argv = crate::networking::libiproute::utils::next_arg(argv);
      if crate::networking::libiproute::rt_names::rtnl_rtscope_a2n(&mut scope, *argv) != 0 {
      ...
      let mut prot: u32 = 0;
      argv = crate::networking::libiproute::utils::next_arg(argv);
      if crate::networking::libiproute::rt_names::rtnl_rtprot_a2n(&mut prot, *argv) != 0 {
        crate::networking::libiproute::utils::invarg_1_to_2(
          *argv,
          keywords
            .as_ptr()
      ...
      argv = crate::networking::libiproute::utils::next_arg(argv);
      metric = crate::networking::libiproute::utils::get_u32(
        *argv,
      ...
      if ((**argv as libc::c_int) < '0' as i32 || **argv as libc::c_int > '9' as i32)
        && crate::networking::libiproute::rtm_map::rtnl_rtntype_a2n(&mut type_0, *argv) == 0i32
      {
        argv = crate::networking::libiproute::utils::next_arg(argv);
  ...
  if !d.is_null() {
    ...
    if !d.is_null() {
      idx = crate::networking::libiproute::ll_map::xll_name_to_index(d);
      crate::networking::libiproute::libnetlink::addattr32(
        &mut req.n,
        ::std::mem::size_of::<C2RustUnnamed_2>() as libc::c_ulong as libc::c_int,
...
unsafe extern "C" fn rtnl_rtcache_request(
  ...
  let mut req: C2RustUnnamed_5 = std::mem::zeroed();
  ...
  return crate::libbb::xfuncs_printf::xsendto(
    (*rth).fd,
    &mut req as *mut C2RustUnnamed_5 as *mut libc::c_void,
    ::std::mem::size_of::<C2RustUnnamed_5>() as libc::c_ulong,
...
unsafe extern "C" fn iproute_flush_cache() {
  ...
  let mut flush_fd: libc::c_int = crate::libbb::xfuncs_printf::open_or_warn(fn_0.as_ptr(), 0o1i32);
  if flush_fd < 0i32 {
    return;
  }
  if write(
  ...
  {
    crate::libbb::perror_msg::bb_simple_perror_msg(
      b"can\'t flush routing cache\x00" as *const u8 as *const libc::c_char,
    );
    return;
  }
  close(flush_fd);
...
unsafe extern "C" fn iproute_list_or_flush(
  ...
  while !(*argv).is_null() {
    ...
    if arg == KW_proto as libc::c_int {
      ...
      if crate::networking::libiproute::rt_names::rtnl_rtprot_a2n(&mut prot, *argv) != 0 {
        if crate::libbb::compare_string_array::index_in_strings(keywords.as_ptr(), *argv)
          != KW_all as libc::c_int
        {
          crate::networking::libiproute::utils::invarg_1_to_2(
            *argv,
      ...
      argv = crate::networking::libiproute::utils::next_arg(argv);
      parm = crate::libbb::compare_string_array::index_in_substrings(keywords.as_ptr(), *argv);
      ...
      if arg == KW_root as libc::c_int {
        argv = crate::networking::libiproute::utils::next_arg(argv); /* "to exact" is the default */
        crate::networking::libiproute::utils::get_prefix(
          &mut (*(bb_common_bufsiz1.as_mut_ptr() as *mut filter_t)).rdst,
          *argv,
          do_ipv6,
  ...
  if !id.is_null() || !od.is_null() {
    let mut idx: libc::c_int = 0;
    if !id.is_null() {
      idx = crate::networking::libiproute::ll_map::xll_name_to_index(id);
      (*(bb_common_bufsiz1.as_mut_ptr() as *mut filter_t)).iif = idx
    }
    if !od.is_null() {
      idx = crate::networking::libiproute::ll_map::xll_name_to_index(od);
...
unsafe extern "C" fn iproute_get(mut argv: *mut *mut libc::c_char) -> libc::c_int {
  let mut rth: rtnl_handle = std::mem::zeroed();
  let mut req: C2RustUnnamed_7 = std::mem::zeroed();
  ...
  while !(*argv).is_null() {
    ...
    match crate::libbb::compare_string_array::index_in_strings(options.as_ptr(), *argv) {
      0 => {
        /* from */
        let mut addr: inet_prefix = inet_prefix {
          family: 0,
  ...
  if !idev.is_null() || !odev.is_null() {
    let mut idx: libc::c_int = 0;
    if !idev.is_null() {
      idx = crate::networking::libiproute::ll_map::xll_name_to_index(idev);
      crate::networking::libiproute::libnetlink::addattr32(
        &mut req.n,
        ::std::mem::size_of::<C2RustUnnamed_7>() as libc::c_ulong as libc::c_int,
    ...
    if !odev.is_null() {
      idx = crate::networking::libiproute::ll_map::xll_name_to_index(odev);
      crate::networking::libiproute::libnetlink::addattr32(
        &mut req.n,
        ::std::mem::size_of::<C2RustUnnamed_7>() as libc::c_ulong as libc::c_int,
        RTA_OIF as libc::c_int,
  ...
  if crate::networking::libiproute::libnetlink::rtnl_talk(&mut rth, &mut req.n, &mut req.n) < 0i32 {
    return 2i32;
  }
  if connected as libc::c_int != 0 && !from_ok {
    ...
    if req.n.nlmsg_type as libc::c_int != RTM_NEWROUTE as libc::c_int {
      crate::libbb::verror_msg::bb_simple_error_msg_and_die(
        b"not a route?\x00" as *const u8 as *const libc::c_char,
      );
    }
    len = (len as libc::c_ulong).wrapping_sub(
      (::std::mem::size_of::<rtmsg>() as libc::c_ulong).wrapping_add(
    ...
    if len < 0i32 {
      crate::libbb::verror_msg::bb_error_msg_and_die(
        b"wrong len %d\x00" as *const u8 as *const libc::c_char,
        len,
      );
    }
    //memset(tb, 0, sizeof(tb)); - parse_rtattr does this
...
pub unsafe extern "C" fn do_iproute(mut argv: *mut *mut libc::c_char) -> libc::c_int {
  ...
  command_num =
    crate::libbb::compare_string_array::index_in_substrings(ip_route_commands.as_ptr(), *argv);
  match command_num {
