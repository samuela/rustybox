...
unsafe extern "C" fn hex_to_bin(mut c: libc::c_uchar) -> libc::c_uint {
  ...
  v = ((c as libc::c_int | 0x20i32) as libc::c_uint).wrapping_sub('a' as i32 as libc::c_uint);
  if v <= 5i32 as libc::c_uint {
    return v.wrapping_add(10i32 as libc::c_uint);
  }
...
pub unsafe extern "C" fn percent_decode_in_place(
  ...
  let mut src: *mut libc::c_char = str;
  ...
  loop {
    ...
    let mut v: libc::c_uint = 0;
    if strict == 0 && c as libc::c_int == '+' as i32 {
      let fresh1 = dst;
      dst = dst.offset(1);
      ...
      *fresh2 = c
      ...
      v = hex_to_bin(*src.offset(0) as libc::c_uchar);
      if !(v > 15i32 as libc::c_uint) {
        v = v.wrapping_mul(16i32 as libc::c_uint) | hex_to_bin(*src.offset(1) as libc::c_uchar);
        if !(v > 255i32 as libc::c_uint) {
          if strict != 0 && (v == '/' as i32 as libc::c_uint || v == '\u{0}' as i32 as libc::c_uint)
          {
