...
static mut capabilities: [*const libc::c_char; 38] = [
  ...
  b"dac_override\x00" as *const u8 as *const libc::c_char,
  b"dac_read_search\x00" as *const u8 as *const libc::c_char,
  b"fowner\x00" as *const u8 as *const libc::c_char,
  b"fsetid\x00" as *const u8 as *const libc::c_char,
  ...
  b"setpcap\x00" as *const u8 as *const libc::c_char,
  b"linux_immutable\x00" as *const u8 as *const libc::c_char,
  b"net_bind_service\x00" as *const u8 as *const libc::c_char,
  b"net_broadcast\x00" as *const u8 as *const libc::c_char,
  b"net_admin\x00" as *const u8 as *const libc::c_char,
  b"net_raw\x00" as *const u8 as *const libc::c_char,
  b"ipc_lock\x00" as *const u8 as *const libc::c_char,
  b"ipc_owner\x00" as *const u8 as *const libc::c_char,
  b"sys_module\x00" as *const u8 as *const libc::c_char,
  b"sys_rawio\x00" as *const u8 as *const libc::c_char,
  b"sys_chroot\x00" as *const u8 as *const libc::c_char,
  b"sys_ptrace\x00" as *const u8 as *const libc::c_char,
  b"sys_pacct\x00" as *const u8 as *const libc::c_char,
  b"sys_admin\x00" as *const u8 as *const libc::c_char,
  b"sys_boot\x00" as *const u8 as *const libc::c_char,
  b"sys_nice\x00" as *const u8 as *const libc::c_char,
  b"sys_resource\x00" as *const u8 as *const libc::c_char,
  b"sys_time\x00" as *const u8 as *const libc::c_char,
  b"sys_tty_config\x00" as *const u8 as *const libc::c_char,
  b"mknod\x00" as *const u8 as *const libc::c_char,
  b"lease\x00" as *const u8 as *const libc::c_char,
  b"audit_write\x00" as *const u8 as *const libc::c_char,
  b"audit_control\x00" as *const u8 as *const libc::c_char,
  b"setfcap\x00" as *const u8 as *const libc::c_char,
  b"mac_override\x00" as *const u8 as *const libc::c_char,
  b"mac_admin\x00" as *const u8 as *const libc::c_char,
  b"syslog\x00" as *const u8 as *const libc::c_char,
  b"wake_alarm\x00" as *const u8 as *const libc::c_char,
...
pub unsafe extern "C" fn cap_name_to_number(mut cap: *const libc::c_char) -> libc::c_uint {
  ...
  if sscanf(
    cap,
    b"cap_%u\x00" as *const u8 as *const libc::c_char,
...
pub unsafe extern "C" fn printf_cap(mut pfx: *const libc::c_char, mut cap_no: libc::c_uint) {
      ...
      as libc::c_uint
  {
    printf(
      ...
      pfx,
      capabilities[cap_no as usize],
    );
    return;
  }
  printf(
    b"%scap_%u\x00" as *const u8 as *const libc::c_char,
    pfx,
    cap_no,
  );
}
  ...
  match current_block {
    ...
    _ => {
      match (*caps).header.version {
        429392688 => (*caps).u32s = 1i32 as libc::c_uint,
