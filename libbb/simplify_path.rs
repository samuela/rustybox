...
pub unsafe extern "C" fn bb_simplify_abs_path_inplace(
  ...
  loop {
    if *p as libc::c_int == '/' as i32 {
      if *s as libc::c_int == '/' as i32 {
        ...
        if *s.offset(1) as libc::c_int == '/' as i32 || *s.offset(1) == 0 {
          current_block_5 = 6239978542346980191;
        } else if *s.offset(1) as libc::c_int == '.' as i32
          && (*s.offset(2) as libc::c_int == '/' as i32 || *s.offset(2) == 0)
        {
          s = s.offset(1);
          if p > start {
            loop
          ...
          current_block_5 = 7976072742316086414;
        }
      } else {
        current_block_5 = 7976072742316086414;
      }
  ...
  if p == start || *p as libc::c_int != '/' as i32 {
