    ...
    if c == '\\' as i32 || c == '%' as i32 {
      ...
      match c {
        83 => {
          ...
          /*FALLTHROUGH*/
          current_block_23 = 13117290041974949857;
        }
        115 => {
          current_block_23 = 13117290041974949857;
        }
        110 | 104 => {
          outbuf = uts.nodename.as_mut_ptr();
          current_block_23 = 7245201122033322888;
        }
        114 => {
          outbuf = uts.release.as_mut_ptr();
          current_block_23 = 7245201122033322888;
        }
        118 => {
          outbuf = uts.version.as_mut_ptr();
          current_block_23 = 7245201122033322888;
        }
        109 => {
          outbuf = uts.machine.as_mut_ptr();
          current_block_23 = 7245201122033322888;
        }
        68 | 111 | 79 => {
          /* The field domainname of struct utsname is Linux specific. */
          outbuf = uts.domainname.as_mut_ptr();
          current_block_23 = 7245201122033322888;
        }
        100 => {
          strftime(
...
static mut forbid: [libc::c_char; 150] = [
  69, 78, 86, 0, 66, 65, 83, 72, 95, 69, 78, 86, 0, 72, 79, 77, 69, 0, 73, 70, 83, 0, 83, 72, 69,
  76, 76, 0, 76, 68, 95, 76, 73, 66, 82, 65, 82, 89, 95, 80, 65, 84, 72, 0, 76, 68, 95, 80, 82, 69,
  76, 79, 65, 68, 0, 76, 68, 95, 84, 82, 65, 67, 69, 95, 76, 79, 65, 68, 69, 68, 95, 79, 66, 74,
  69, 67, 84, 83, 0, 76, 68, 95, 66, 73, 78, 68, 95, 78, 79, 87, 0, 76, 68, 95, 65, 79, 85, 84, 95,
  76, 73, 66, 82, 65, 82, 89, 95, 80, 65, 84, 72, 0, 76, 68, 95, 65, 79, 85, 84, 95, 80, 82, 69,
...
pub unsafe extern "C" fn sanitize_env_if_suid() -> libc::c_int {
  ...
  return 1i32;
  /* we indeed were run by different user! */
}
