 ...
 */
unsafe extern "C" fn xmalloc_fgets_internal(
  mut file: *mut FILE,
...
pub unsafe extern "C" fn xmalloc_fgetline_str(
  ...
  let mut maxsz: size_t = (2147483647i32 - 4095i32) as size_t;
  return xmalloc_fgets_internal(file, terminating_string, 1i32, &mut maxsz);
}
